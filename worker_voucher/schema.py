...
from worker_voucher.gql_mutations import CreateWorkerVoucherMutation, UpdateWorkerVoucherMutation, \
    ...
    CreateOrUpdateVoucherFormDraftMutation, SetVoucherToPrintedMutation, UnassignVouchersMutation
...
class Query(ExportableQueryMixin, graphene.ObjectType):
    ...
    def resolve_worker(self, info, client_mutation_id=None, economic_unit_code=None,id=None, **kwargs):
...
class Mutation(graphene.ObjectType):
    ...
    unassign_vouchers = UnassignVouchersMutation.Field()
